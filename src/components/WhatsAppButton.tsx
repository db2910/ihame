...
const WhatsAppButton: React.FC = () => {
  const phoneNumber = '250788364404';
  const message = 'Hello IHAME LOGISTICS team, I would like to inquire about your logistics services. Please let me know the next steps. Thank you.';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <a
        ...
        className="group flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20BA5A] rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
        aria-label="Contact us on WhatsApp"
      >
        {/* Latest WhatsApp Icon SVG */}
        <svg
